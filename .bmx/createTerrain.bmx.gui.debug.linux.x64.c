...
int _bb_main(){
	if (!_bb_main_inited) {
		...
		struct BBDebugStm __stmt_1 = {0x1302e4b9354befcf, 9, 0};
		...
		struct BBDebugStm __stmt_2 = {0x1302e4b9354befcf, 10, 0};
		...
		struct BBDebugStm __stmt_3 = {0x1302e4b9354befcf, 12, 0};
		...
		struct BBDebugStm __stmt_4 = {0x1302e4b9354befcf, 13, 0};
		...
		struct BBDebugStm __stmt_5 = {0x1302e4b9354befcf, 15, 0};
		...
		while(!(brl_polledinput_KeyDown(27)!=0)){
			...
			struct BBDebugStm __stmt_1 = {0x1302e4b9354befcf, 34, 0};
			bbOnDebugEnterStm(&__stmt_1);
			...
			struct BBDebugStm __stmt_2 = {0x1302e4b9354befcf, 35, 0};
			bbOnDebugEnterStm(&__stmt_2);
			...
			struct BBDebugStm __stmt_3 = {0x1302e4b9354befcf, 36, 0};
			bbOnDebugEnterStm(&__stmt_3);
			...
			struct BBDebugStm __stmt_4 = {0x1302e4b9354befcf, 37, 0};
			bbOnDebugEnterStm(&__stmt_4);
			if(brl_polledinput_KeyDown(87)==1){
				...
				bbOnDebugEnterScope(&__scope);
				struct BBDebugStm __stmt_0 = {0x1302e4b9354befcf, 37, 0};
				bbOnDebugEnterStm(&__stmt_0);
			...
			struct BBDebugStm __stmt_5 = {0x1302e4b9354befcf, 38, 0};
			bbOnDebugEnterStm(&__stmt_5);
			if(brl_polledinput_KeyDown(83)==1){
				...
				bbOnDebugEnterScope(&__scope);
				struct BBDebugStm __stmt_0 = {0x1302e4b9354befcf, 38, 0};
				bbOnDebugEnterStm(&__stmt_0);
				openb3d_openb3dcore_MoveEntity((struct openb3d_openb3dcore_TEntity_obj*)((struct openb3d_openb3dcore_TEntity_obj*)bbObjectDowncast((BBOBJECT)bbt_camera,(BBClass*)&openb3d_openb3dcore_TEntity)),0.00000000f,-1.00000000f,0.00000000f);
				bbOnDebugLeaveScope();
			}
			struct BBDebugStm __stmt_6 = {0x1302e4b9354befcf, 39, 0};
			bbOnDebugEnterStm(&__stmt_6);
			...
			struct BBDebugStm __stmt_7 = {0x1302e4b9354befcf, 40, 0};
			bbOnDebugEnterStm(&__stmt_7);
			...
			struct BBDebugStm __stmt_8 = {0x1302e4b9354befcf, 41, 0};
			bbOnDebugEnterStm(&__stmt_8);
			...
			struct BBDebugStm __stmt_9 = {0x1302e4b9354befcf, 43, 0};
			bbOnDebugEnterStm(&__stmt_9);
			...
			struct BBDebugStm __stmt_10 = {0x1302e4b9354befcf, 45, 0};
			bbOnDebugEnterStm(&__stmt_10);
			...
			struct BBDebugStm __stmt_11 = {0x1302e4b9354befcf, 47, 0};
			bbOnDebugEnterStm(&__stmt_11);
			openb3d_openb3dcore_RenderWorld();
			struct BBDebugStm __stmt_12 = {0x1302e4b9354befcf, 49, 0};
			bbOnDebugEnterStm(&__stmt_12);
			openb3d_b3dglgraphics_Text(0,0,((BBString*)&_s3));
			struct BBDebugStm __stmt_13 = {0x1302e4b9354befcf, 51, 0};
